...
const FeaturedProjects = () => {
  ...
  useGSAP(() => {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        start: "top 20%",
        end: () => `+=${3 * window.innerHeight}`, // adjust total scroll
        // end: "bottom center",
        scrub: 1, // smooth scroll animation
        pin: true, // pins container while scrolling
        markers: true,
      },
    });
  ...
  return (
    <>
      <section className="lg:hidden py-20 bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-950 dark:to-blue-950">
      ...
      <div className="relative">
        ...
        <div
          ref={containerRef}
          className="flex flex-col con relative min-h-[80vh]"
        >
          {projectsT.map((e, i) => {
            return (
              <h2
          ...
          {projectsT.map((e, i) => {
            return (
              <div
                ...
                key={e.id}
                className="w-auto rounded-tl-4xl rounded-tr-4xl overflow-hidden absolute inset-0"
              >
                <Image
                  ref={(el) => {
                  ...
                  height={1000}
                  alt="img"
                  className="object-cover w-full scale-105"
                />
              </div>
            );
          })}
